...
export default function Fir() {
    ...
    if(victim_name&&victim_contact && victim_location && victim_description){
      ...
      axios.post("http://127.0.0.1:3001/api/post/firs/case",{
        victim_name,
        victim_contact,
        date,
        criminalName,
  ...
  return (
    <div>
        ...
        <h2 className="text-danger fw-bold">FIR file Cell</h2>
        <p className="text-muted">Ensuring Safety, Empowerment & Support for Every human</p>
      </div>
